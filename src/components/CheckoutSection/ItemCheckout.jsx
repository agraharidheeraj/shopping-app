...
const CheckoutPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const requiredFields = Object.keys(formData).filter((key) => key !== 'sameAsShipping');
    ...
    <div className="container mx-auto my-8" style={{ width: '80%' }}>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2 pr-4 mb-8">
          ...
          <div className={`mb-4 pb-2 border-b `}>
            <label htmlFor="shippingAddress" className="block text-sm text-gray-300">
              Address:
            </label>
            <input
              type="text"
          ...
          {sameAsShipping && (
            <>
              ...
              <div className={`mb-4 pb-2 border-b `}>
                <label htmlFor="billingAddress" className="block text-sm text-gray-300">
                  Address:
                </label>
                <input
                  type="text"
              ...
              <div className={`mb-4 pb-2 border-b `}>
                <label htmlFor="billingCity" className="block text-sm text-gray-300">
                  City:
                </label>
                <input
                  type="text"
              ...
              <div className={`mb-4 pb-2 border-b `}>
                <label htmlFor="billingZipCode" className="block text-sm text-gray-300">
                  ZIP Code:
                </label>
                <input
                  type="text"
              ...
              <div className={`mb-4 pb-2 border-b `}>
                <label htmlFor="billingCountry" className="block text-sm text-gray-300">
                  Country:
                </label>
                <input
                  type="text"
        ...
        <div className="w-full lg:w-1/2 pl-4 mb-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className={`mb-4 pb-2 border-b `}>
              <label htmlFor="cardholderName" className="block text-sm text-gray-300">
                Cardholder Name:
              </label>
              <input
                type="text"
            ...
            <div className="mb-4 pb-2">
              <p className="text-sm text-gray-300">Item 1: $20.00</p>
            </div>
            <div className="mb-4 pb-2">
              <p className="text-sm text-gray-300">Item 2: $30.00</p>
            </div>

            {/* Total Price */}
            <div className="mt-8">
              <p className="text-xl font-semibold text-gray-300">Total Amount: $50.00</p>
            </div>
      ...
      {isPaymentSuccessful && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-8 rounded shadow">
            <p className="text-2xl font-semibold mb-4">Thanks for your payment!</p>
            <button onClick={closePopup} className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">
              Close
            </button>
          </div>
        </div>
