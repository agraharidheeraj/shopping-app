export const ladiesOuterwearItems=[
    {
    "name": "Ladies+Modern+Stretch+Full+Zip",
    "title": "Ladies Modern Stretch Full Zip",
    "category": "ladies_outerwear",
    "price": 41.6,
    "description": "With an updated fit and figure-flattering details, this full-zip combines ultra soft cotton with a dash of spandex to retain its shape all day long.&amp;nbsp;&lt;div&gt;&lt;br&gt;&lt;/div&gt;&lt;div&gt;Features:&lt;/div&gt;&lt;div&gt;&lt;ul&gt;&lt;li&gt;96% cotton, 4% spandex.&lt;/li&gt;&lt;li&gt;Gently contoured silhouette &amp;amp; longer length design for a style that moves with you.Dyed-to-match zipper.Available in Mosaic Blue with the white Google logo embroidered at left chest.",
    ...
    export const ladiesTShirtsItems= [
        {
        ...
        "category": "ladies_tshirts",
        "price": 10.6,
        "description": "The softest, smoothest, best-looking, organic cotton tee shirt available anywhere.&amp;nbsp;&lt;div&gt;&lt;br&gt;&lt;/div&gt;&lt;div&gt;Features:&lt;/div&gt;&lt;div&gt;&lt;ul&gt;&lt;li&gt;100% certified organic, combed, ringspun cotton.&lt;/li&gt;&lt;li&gt;Contoured to flatter women's curves.&lt;/li&gt;&lt;li&gt;Double-needle stitching on the sleeves and bottom hem.&lt;/li&gt;&lt;li&gt;TearAway™ label for added comfort.&amp;nbsp;&lt;/li&gt;&lt;li&gt;Available in Berry with a screened Android robot at front chest.",
        "image": "data/images/10-23069B.jpg",
        "largeImage": "data/images/10-23069A.jpg"
        }
        ]
        export const mensOuterwearItems = [
            {
                "name": "Men+s+Tech+Shell+Full-Zip",
                "title": "Men's Tech Shell Full-Zip",
                "category": "mens_outerwear",
                "price": 50.2,
                "description": "A versatile full-zip that you can wear all day long and even to the gym. This technical shell features moisture-wicking fabric, added stretch, and a hidden pocket for your smartphone or media player. Features: 100% polyester. Smooth, technical front with textured mesh back. Drawstring bottom for adjustable fit. Raglan sleeves. Available in forest green with the white Google logo embroidered at left chest.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 45.65,
                "description": "Ultra soft. Ultra cozy. Our popular flex fleece hoodie now available in speckled green. Features: 50% cotton / 50% polyester. Made in the USA. Full-zip. Available in green with specks of blue and the white Google logo embroidered at left bicep.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 33.6,
                "description": "Pack. Pack. Pack it up! This nylon jacket with reflective trim can literally be packed into itself in seconds. Features a waterproof nylon fabric, Android eyes & antennae on the hood and a carrying strap when the jacket is fully packed. Android robot is printed on the back above the zipper in a reflective, metallic finish.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 32.35,
                "description": "Stay warm in this cozy hoodie made of 50% cotton and 50% polyester. This comfortable design features set in sleeves, dyed to match drawcord, and a front pouch pocket. Available in Charcoal with the full-color YouTube logo screen printed across the chest. Unisex sizing.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 38.85,
                "description": "Cozy up with this full-zip hoodie. Features: 60% combed, ring-spun cotton, 40% polyester. Unisex sizing. Retail fit. Contrast zipper. Kangaroo pockets with ribbed cuffs and waistband. Available in dark heather with the white Google logo embroidered at left chest.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 200,
                "description": "The ultimate in fit and fabric, this Vastrm hoodie doesn't disappoint. Made from soft pique fabric, the lightweight full-zip features a half-moon accent and matching hoodie strings. Additional Features: 100% cotton. Hidden phone pocket neatly cradles your digital device. Available in charcoal grey with red strings and hood. White Google logo is embroidered at the left bicep.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 60.95,
                "description": "Ever wonder where all of the disposable water bottles of the world end up? We know some of them are reused for a second purpose. Each of these hoodies contains approximately 9 recycled water bottles that are woven into the fabric. Features: 50% recycled cotton, 50% recycled polyester. Full zipper and orange drawstring pulls. USA made. Available in forest green with the white Google logo embroidered at the left bicep.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 60.85,
                "description": "In search of the perfect layering piece? This lightweight, triblend pullover is ultra soft and ideal for all seasons. Features: 50% polyester, 38% cotton, 12% rayon triblend. Available in black with the white Google logo screenprinted at left bicep.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 48,
                "description": "Perhaps the equivalent to that comfort blanket you had years ago is a cozy fleece. This full-zip is the perfect layering piece for those 'in-between' months when mother nature just can't make up her mind. Features: 100% polyester anti-pill yarn fleece. 100% polyester taffeta lining in sleeves. Tricot-lined lower pockets with reverse coil zippers. Available in black with the white Google logo embroidered at left chest.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 37.75,
                "description": "An exceptionally soft, eco-friendly full-zip for picture-perfect layering. Features: 50% polyester, 38% cotton (6.25% recycled), 12% rayon (6.25% organic). Low-impact yarn dyed and washed. Brushed nickel zipper with natural taping. Split front pouch pocket. Available in deep pacific blue with the white Google Chrome logo screenprinted at the left chest.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 50.2,
                "description": "This cozy Android hoodie features a sublimated camo design printed inside the hood and along inner sleeves and side panels. Moisture-wicking polyester fabric keeps you cool and dry. Features: 100% polyester. Ultra-soft, fleece interior. Available in smoke/lime green with the white Android robot embroidered at left chest.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 45.65,
                "description": "If you find that the 'spark' is missing from your outfit, you may need to add one of these full-zip hoodies to the mix. Resurfacing from 1989, this colorful full-zip features a sporty fit with ultra-soft fleece lining. Additional Features: 50% polyester and 50% cotton fleece. Available in blue with the Google logo embroidered in white at left bicep.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 74.9,
                "description": "We love color contrast, especially in Google Blue! This textured jacket features a jacquard texture with contrast stitching and zippers. Additional Features: 100% polyester. Audio port access available on inside left pocket. Available in Carbon/Olympic Blue with the Google logo embroidered in white on the left chest.",
            ...
            },
            {
                ...
                "category": "mens_outerwear",
                "price": 45.25,
                "description": "Our popular flex fleece hoodie, now for YouTube fans everywhere. Features: 50% polyester, 50% cotton fleece. Sporty, unisex fit. Metal zipper. Hood. Available in dark heather grey with the YouTube logo embroidered at left bicep.",
